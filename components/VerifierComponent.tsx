                      ...
                      {result.valid && result.data && (
                        <div style={{background:'white',borderRadius:'12px',padding:'16px',border:'1px solid rgba(56,161,105,0.2)'}}>
                          ...
                          <div style={{display:'flex',gap:'8px',marginTop:'16px'}}>
                            <button style={{flex:1,padding:'10px',background:'linear-gradient(135deg,#667eea,#764ba2)',border:'none',borderRadius:'10px',color:'white',fontWeight:700,cursor:'pointer',fontSize:'0.85rem'}}>View Original PDF</button>
                            <button style={{flex:1,padding:'10px',background:'white',border:'2px solid #ddd',borderRadius:'10px',color:'#555',fontWeight:700,cursor:'pointer',fontSize:'0.85rem'}}>View Student Photo</button>
                          </div>
                        </div>
                      )}
                    </div>
